...
$('#invertednextStep').click(function () {

    var model = $("input[name='model']:checked").val();
    if (model == "vectorSpace") {
        document.getElementById("invertedindexLink").href = "../IRforCN/informationretrieval/vectorSpaceModel.html";
    }
    else if (model == "boolean") {
        document.getElementById("invertedindexLink").href = "../IRforCN/informationretrieval/boolean.html";
    } else if (model == "probability") {
        document.getElementById("invertedindexLink").href = "../IRforCN/informationretrieval/probabilityModel.html";
    } else if (model == "languageModel") {
        document.getElementById("invertedindexLink").href = "../IRforCN/informationretrieval/vectorSpaceModel.html";
    }
...
function getDoc(docId,term) {
    ...
    $.ajax({
        type: "POST",
        url: "invertedIndex/getDoc",
        data: {"docId":docId,"term":term},
        dataType: "text",
        contentType: "application/x-www-form-urlencoded; charset=utf-8",
        traditional: true,
        success: function (result) {
